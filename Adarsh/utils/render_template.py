...
async def render_page(id, secure_hash):
    ...
    template_path = TEMPLATE_PATH_VIDEO if file_data.mime_type.startswith('video') else TEMPLATE_PATH_AUDIO if file_data.mime_type.startswith('audio') else TEMPLATE_PATH_OTHER

    async with aiofiles.open(template_path) as r:
        tag = file_data.mime_type.split('/')[0].strip()
        heading = f'Watch {file_data.file_name}' if tag == 'video' else f'Listen {file_data.file_name}' if tag == 'audio' else f'Download {file_data.file_name}'
...
# <center>
#     <h2>
#         <a href="https://telegram.me/NobiDeveloper">
#             <img src="https://graph.org/file/b57cdba982191a25db535.jpg" alt="BotszList" width="150" height="75">
#         </a>
#     </h2>
# </center>
